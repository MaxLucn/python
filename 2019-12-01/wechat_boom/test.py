...
# boomName = input('输入要轰炸的人，按回车继续')
# messange = input('输入要轰炸的内容')
# boom_obj = itchat.search_friends(remarkName=boomName)[0]['UserName']
# # 开始轰炸
# while True:
#     time.sleep(0.4)
#     print('正在轰炸。。。')
#     itchat.send_msg(msg=messange, toUserName=boom_obj)
