    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('town', models.CharField(max_length=32, null=True, verbose_name='乡/镇')),
                ...
                ('is_valid', models.BooleanField(default=True, verbose_name='')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建的时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='修改的时间')),
            ],
            options={
                'db_table': 'sight',
                'ordering': ['-updated_at'],
