...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='sight',
            name='banner_img',
            field=models.ImageField(max_length=256, upload_to='%Y%m/sight/', verbose_name='详情主图'),
        ),
        migrations.AlterField(
            model_name='sight',
            name='created_at',
        ...
        migrations.AlterField(
            model_name='sight',
            name='main_img',
            field=models.ImageField(max_length=256, upload_to='%Y%m/sight/', verbose_name='主图'),
        ),
        migrations.AlterField(
            model_name='sight',
            name='town',
            field=models.CharField(max_length=32, null=True, verbose_name='乡镇'),
        ),
        migrations.AlterField(
            model_name='sight',
            name='updated_at',
